...
int main() {
    ...
    auto material_left   = make_shared<metal>(color(0.8, 0.6, 0.2), 0.3); // Slightly rough metal
    auto material_center = make_shared<emissive>(color(4.0, 2.0, 2.0)); // Emissive material
    auto material_right  = make_shared<dielectric>(1.5); // Glass-like material

    // Add spheres
    world.add(make_shared<sphere>(point3( 0.0, -100.5, -1.0), 100.0, material_ground)); // Ground sphere
    world.add(make_shared<sphere>(point3( 0.0,    0.0, -1.0),   0.5, material_center)); // Center emissive sphere
    world.add(make_shared<sphere>(point3(-1.0,    0.0, -1.0),   0.5, material_left));   // Left metallic sphere
    world.add(make_shared<sphere>(point3( 1.0,    0.0, -1.0),   0.5, material_right));  // Right dielectric sphere
